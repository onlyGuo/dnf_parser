package com.xiaoyouma.dnf.parser.pvf.coder;

import cn.hutool.core.lang.Singleton;
import cn.hutool.json.JSONObject;
import com.xiaoyouma.dnf.parser.pvf.model.Pvf;
import com.xiaoyouma.dnf.parser.pvf.model.PvfScriptData;
...
public class PvfCoder {
     ...
     * @param path 脚本路径
     */
    public static String loadScriptSource(String path) {
        return pvf.getScriptSource(path);
    }
